...
#define D3DX_FILTER_BILINEAR 3
#define D3DX_FILTER_TRILINEAR 4
#define D3DX_FILTER_BOX 5
#define D3DX_FILTER_TRIANGLE 6

// Added for the TH095 port (homogeneous projected vertices in AnmDrawCore).
struct D3DXVECTOR4
{
    FLOAT x, y, z, w;
    D3DXVECTOR4() {}
...
// The reconstruction calls this with (dest, destRect(=NULL), destRect2, memory,
// format, pitch, reserved(=NULL), srcRect, filter, colorKey); see the port
// notes in d3dx8_compat.cpp.
HRESULT D3DXLoadSurfaceFromMemory(IDirect3DSurface8 *, const RECT *, const RECT *,
                                  const void *, D3DFORMAT, int, const RECT *,
...
void D3DXVec4Transform(D3DXVECTOR4 *out, const D3DXVECTOR4 *in, const D3DXMATRIX *m);
