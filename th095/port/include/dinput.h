...
class IDirectInput8A
{
  public:
    ...
    virtual HRESULT EnumDevices(const GUID, LPDIENUMDEVICESCALLBACKA, LPVOID, DWORD) = 0; // th095 port
...
// Added for the TH095 port.
extern const DIDATAFORMAT c_dfDIJoystick2;
extern const GUID DI8DEVCLASS_GAMECTRL;
